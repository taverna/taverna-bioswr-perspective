...
public class ServiceTypeCellRenderer extends DefaultTableCellRenderer {
    ...
    public void setValue(Object value) {
        if (value instanceof OWLNamedIndividual) {
            ...
            OWLIndividual binding = ontology.getBinding(service);
            if (binding == null) {
                setIcon(null);
            } else if (ontology.isSOAPBinding(binding)) {
                    setIcon(BioswrIcons.SOAP_ICON);
            } else if (ontology.isHTTPBinding(binding)) {
                setIcon(BioswrIcons.REST_ICON);
            } else {
                setIcon(null);
            }
        } else {
